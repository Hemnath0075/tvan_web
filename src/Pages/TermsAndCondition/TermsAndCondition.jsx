  ...
  return (
    <div>
      ...
      <div className="w-full px-10">
        <div className="">
          <h1 className="text-3xl py-4 text-[#468B93] text-center">Terms and Condition</h1>
          <p>
            Thank you for accessing/shopping at www.tvanjewellers.com. This site
            is owned by TVAN Jewellers (here in after referred to as
            “www.tvanjewellers.com”). By accessing, shopping on this site, you
            ...
            acceptance of those changes. At “www.tvanjewellers.com”, we try our
            ...
            information displayed on “www.tvanjewellers.com” constitutes an
            "invitation to offer". “www.tvanjewellers.com” reserves the right to
          ...
          <h1 className="text-2xl py-2 text-[#468B93]">1. Eligibility to use our site</h1>
          <p>
            ...
            including un-discharged insolvents etermsAndCondition. are not eligible to use the
            Site. “www.tvanjewellers.com” reserves the right to terminate your
          ...
          <h1 className="text-2xl py-2 text-[#468B93]">2. Membership</h1>
          <p>
            Although it's not essential to have an account to shop with
            “www.tvanjewellers.com”, you can shop as a guest. As a member, you
            ...
            “www.tvanjewellers.com” reserves the right to revoke or terminate
            your registration for any reason at any time, without notice.
          </p>
          <h1 className="text-2xl py-2 text-[#468B93]">3. Electronic Communications</h1>
          <p>
          ...
          <h1 className="text-2xl py-2 text-[#468B93]">4. Reviews, Feedback, Submissions</h1>
          <p>
            All reviews, comments, feedback, postcards, suggestions, ideas, and
            other submissions disclosed, submitted or offered to
            “www.tvanjewellers.com” directly or otherwise disclosed, submitted
            or offered in connection with your use of this Site (collectively
            referred to "Comments") will remain "www.tvanjewellers.com"
            property. Such disclosure, submission or offer of any comments shall
            constitute an assignment to “www.tvanjewellers.com” of all worldwide
            ...
            any way in its use, commercial or otherwise. “www.tvanjewellers.com”
            ...
            without compensating you in any way. “www.tvanjewellers.com” is and
            ...
            other personal or proprietary right(s), and will not cause injury to
            any person or entity. You further agree that no comments submitted
            by you to the site will be libelous or otherwise unlawful,
            ...
            “www.tvanjewellers.com” does not regularly review posted comments,
            ...
            "www.tvanjewellers.com" the right to use the name that you submit in
            ...
            mislead as to the origin of any Comments you submit. You are and
            shall remain solely responsible for the content of any comments you
            make and you agree to indemnify “www.tvanjewellers.com” and its
            affiliates for all claims resulting from any Comments you submit, we
          ...
          <p className="mb-10">
            While “www.tvanjewellers.com” strives to provide accurate product
            and pricing information, typographical errors may occur. In the
            event that a product is listed at an incorrect price or with
            incorrect information due to an error in pricing or product
            information, “www.tvanjewellers.com” shall have the right, on our
            sole discretion, to modify the price of the products, or information
            of the products or to refuse or cancel any orders placed for that
